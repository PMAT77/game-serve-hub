...
GSH_RELEASE_TAG="${GSH_RELEASE_TAG:-${PANEL_IMAGE_TAG:-v0.4.3}}" # 默认安装的不可变 Release；同时锁定安装资源与镜像版本。
...
INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML="${INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML:-c13160030d8a0fa99753c319f35e1b43855cb097236b6fb5ac1dfe62e8c24307}"
