...
GSH_RELEASE_TAG="${GSH_RELEASE_TAG:-${PANEL_IMAGE_TAG:-v0.6.0}}" # 默认安装的不可变 Release；同时锁定安装资源与镜像版本。
...
INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML="${INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML:-19b3518f4bef8cefaeedb52a1a7e933eb638d2ff38919569d43c98cda1904fd1}"
