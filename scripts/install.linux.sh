...
GSH_RELEASE_TAG="${GSH_RELEASE_TAG:-${PANEL_IMAGE_TAG:-v0.8.2}}" # 默认安装的不可变 Release；同时锁定安装资源与镜像版本。
...
INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML="${INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML:-2419c52a72212e4c7a38afdb1c7e2b301233d24d2d31643292998e9129608a54}"
