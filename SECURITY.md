...
```bash
curl -fL -o install.sh https://github.com/PMAT77/game-serve-hub/releases/download/v0.9.0/install-v0.9.0.sh
curl -fL -o install.sh.sha256 https://github.com/PMAT77/game-serve-hub/releases/download/v0.9.0/install-v0.9.0.sh.sha256
