...
```bash
curl -fL -o install.sh https://github.com/PMAT77/game-serve-hub/releases/download/v0.6.10/install-v0.6.10.sh
curl -fL -o install.sh.sha256 https://github.com/PMAT77/game-serve-hub/releases/download/v0.6.10/install-v0.6.10.sh.sha256
