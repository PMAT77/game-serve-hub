...
GSH_RELEASE_TAG="${GSH_RELEASE_TAG:-${PANEL_IMAGE_TAG:-v0.4.0}}" # 默认安装的不可变 Release；同时锁定安装资源与镜像版本。
...
INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML="${INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML:-a0e1c93582f0477b5b4844054081569c1eac11281efb7b68816b236295c7ded8}"
