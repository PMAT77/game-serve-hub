...
GSH_RELEASE_TAG="${GSH_RELEASE_TAG:-${PANEL_IMAGE_TAG:-v0.8.1}}" # 默认安装的不可变 Release；同时锁定安装资源与镜像版本。
...
INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML="${INSTALLER_ASSET_SHA256_DOCKER_COMPOSE_YML:-fad266dfb9825d9ebf50faf852a1dfb426cb51e7437825880285aa638fe4c107}"
